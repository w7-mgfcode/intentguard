# S03.2 — Persist and reload the baseline artifact with parity


## Migration identity

- Canonical identifier: `S03.2` (GitHub issue type: subtask).
- Legacy identifier: `C03.2` (retained as `old_identifier`).
- Parent epic: `E03`.
