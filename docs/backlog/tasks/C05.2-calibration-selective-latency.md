# S05.2 — Measure calibration, selective prediction, and latency


## Migration identity

- Canonical identifier: `S05.2` (GitHub issue type: subtask).
- Legacy identifier: `C05.2` (retained as `old_identifier`).
- Parent epic: `E05`.
