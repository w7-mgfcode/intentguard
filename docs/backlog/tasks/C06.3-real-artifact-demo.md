# S06.3 — Deliver the strict real-artifact demonstration


## Migration identity

- Canonical identifier: `S06.3` (GitHub issue type: subtask).
- Legacy identifier: `C06.3` (retained as `old_identifier`).
- Parent epic: `E06`.
