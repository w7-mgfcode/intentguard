# S08.2 — Finalize operations, implementation status, and limitations


## Migration identity

- Canonical identifier: `S08.2` (GitHub issue type: subtask).
- Legacy identifier: `C08.2` (retained as `old_identifier`).
- Parent epic: `E08`.
