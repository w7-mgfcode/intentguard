...
calibration, risk/coverage curves, and single-request latency. U05 is Partial —
the unsupported-request fixture is outstanding. Service and demo scripts remain
planned under U06.
